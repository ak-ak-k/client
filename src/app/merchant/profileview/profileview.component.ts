...
export class ProfileviewComponent implements OnInit {
  ...
  kycLists: kyc[] = [
    { value: 'steak-0', viewValue: 'Flat' },
    { value: 'pizza-1', viewValue: 'Percentage' },
  ];
  ...
  capname: name[] = [
    { value: 'steak-0', viewValue: 'Aditya' },
    { value: 'pizza-1', viewValue: 'Abc' },
  ];

  totalearned: total[] = [
    { value: 'steak-0', viewValue: '10,000' },
    { value: 'pizza-1', viewValue: '20,000' },
  ];
