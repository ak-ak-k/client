...
@Component({
  selector: 'app-profilewallets',
  templateUrl: './profilewallets.component.html',
  styleUrls: ['./profilewallets.component.scss'],
})
export class ProfilewalletsComponent implements OnInit {
  selected = 'option2';
