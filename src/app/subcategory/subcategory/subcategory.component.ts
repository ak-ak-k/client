...
import { UpdatesubcategoryComponent } from '../updatesubcategory/updatesubcategory.component';
...
export class SubcategoryComponent implements OnInit {
  ...
  create() {
    ...
    const profile = this.dialog.open(AddsubcategoryComponent, {
      width: w,
      minWidth: '950px',
      maxWidth: '320px',
      // height: h,
  ...
  update() {
    let isPhone = this.getWidth < 768;
    let w = isPhone ? this.getWidth + 'px' : '480px';
    const profile = this.dialog.open(UpdatesubcategoryComponent, {
      width: w,
      minWidth: '950px',
      maxWidth: '320px',
      // height: h,
